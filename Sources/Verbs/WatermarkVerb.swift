...
interactive, structure-preserving); --rotate-mark does not apply in that mode,
and --image cannot be combined with it.
...
Options:
      ...
      --point-size N      Text point size (default: 1/10 of the page diagonal)
      --under             Draw beneath the page content instead of over it
